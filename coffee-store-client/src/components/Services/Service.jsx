          ...
          <div className="w-[50%]">
            <div className="w-full">
              ...
              <p className="md:w-[70%]  text-xl py-8">
                ...
                offering a rich aroma, bold flavor, and energizing caffeine.
                It's enjoyed in countless variations like espresso, cappuccino,
                and latte, making it a staple for relaxation.
              </p>
              <div className="space-y-8">
                <div className="flex gap-4 items-center">
                  ...
                  <div className="">
                    ...
                    <p>
                      ...
                      Praesent gravida hendrerit ex, nec eleifend sem convallis
                      vitae.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div className="">
                    ...
                    <p>
                      Sed sagittis sodales lobortis. Curabitur in eleifend
                      turpis, id vehicula odio. Donec pulvinar tellus eget magna
                      aliquet ultricies.
                    </p>
                  </div>
                </div>
