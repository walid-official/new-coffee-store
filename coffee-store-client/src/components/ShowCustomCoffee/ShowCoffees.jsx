        ...
        {coffees.map((coffee, index) => (
          ...
          >
            <figure className="flex justify-center">
              <img src={coffee.photo} alt="coffee" className="" />
            </figure>
            <div className="p-6 text-center">
              ...
              <div className="flex justify-center space-x-3 mt-4">
                ...
                <NavLink
                  ...
                  className="px-4 py-2 cursor-pointer border-2 border-[#E3B577] text-[#E3B577] font-medium rounded-lg hover:bg-[#E3B577] hover:text-white transition"
                >
                  View Details
                </NavLink>
              </div>
